window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const dshBrandCss = ".dsh-brand-bobu{display:block;width:27px;height:27px;object-fit:contain}.dsh-brand-anydoor{white-space:nowrap;letter-spacing:.08em;font-size:19px;font-weight:700;line-height:24px}.hHd-Xa_collapsed .dsh-brand-bobu{width:24px;height:24px}";
		...
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId) + "]") === null) {
			...
			tag.textContent = css + dshBrandCss;
						...
						children: [wide && (0, react_jsx_runtime.jsx)("button", {
							...
							children: (0, react_jsx_runtime.jsxs)("span", {
								...
								children: [(0, react_jsx_runtime.jsx)("span", {
									...
									children: (0, react_jsx_runtime.jsx)("img", { src: "/assets/dsh-brand-bobu.png", alt: "", className: "dsh-brand-bobu" })
								}), (0, react_jsx_runtime.jsx)("span", {
									className: SidebarRoot_module_css_default.brandName,
									children: (0, react_jsx_runtime.jsx)("span", { className: "dsh-brand-anydoor", children: "任意门" })
								})]
							})
