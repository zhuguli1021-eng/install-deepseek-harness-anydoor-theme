		...
		*/
		...
		const dshBobuThemeCss = `
			...
			.wSkVaW_root[data-phase="hero"] .uV2eYG_card {
				...
				border-color: rgba(128,92,38,.14) !important;
				box-shadow: 0 16px 44px rgba(101,73,32,.12) !important;
			}
			.dshpet-wrap {
		...
		`;
		if (typeof document !== "undefined" && document.querySelector("style[data-dsh-bobu-theme]") === null) {
			const dshBobuThemeTag = document.createElement("style");
			dshBobuThemeTag.dataset.dshBobuTheme = "true";
			dshBobuThemeTag.textContent = dshBobuThemeCss;
			document.head.appendChild(dshBobuThemeTag);
		}
			...
			return (0, react_jsx_runtime.jsxs)("button", {
				...
				children: [
					(0, react_jsx_runtime.jsx)("span", {
						...
						children: ["#2563eb", "#facc15", "#ec4899", "#f97316", "#22c55e"].map((color) => (0, react_jsx_runtime.jsx)("i", { style: {
							width: 5,
							height: 5,
							borderRadius: "50%",
							background: color,
